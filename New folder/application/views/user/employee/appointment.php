                    ...
                    <div class="col-lg-7 col-xlg-7 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="<?php echo base_url() . 'employee-appointment/' . $trans['id'] . "/complete"; ?>" class="btn btn-info" style="color:white">COMPLATE APPOINTMENT</a>
                                <a href="<?php echo base_url() . 'employee-appointment/' . $trans['id'] . "/cancel"; ?>" class="btn btn-danger" style="color:white">CANCEL APPOINTMENT</a>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
