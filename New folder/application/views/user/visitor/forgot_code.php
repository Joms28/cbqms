			...
			<div class="row justify-content-md-center" style="padding:30px">
				...
				<div class="col-md-3">
					...
					<div class="card shadow">
					  ...
					  <div class="card-body">
							<?php echo form_open(base_url() . 'forgot/verif/' . $forgot['id'] ); ?>
							...
							<?php endif; ?>
								...
								<div class="form-group">
									<label style="color:gray">Enter verification code sent to your email</label>
									<input type="text" class="form-control" name="code" placeholder="Enter 4 digit code">
									<?php echo form_error('code', '<small><span style="color:red;font-size: small">', '</strong></small><br>'); ?>
								</div>

								<button class="btn btn-primary btn-block">PROCESS</button>
