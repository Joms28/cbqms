		...
		<div class="container-fluid" style="background:	rgba(255,250,205,0.6);background-size: cover;height:100%">
			...
			<div class="row justify-content-md-center" style="padding:30px">
              ...
              ?>
							...
							<?php echo form_open(base_url() . 'forgot/change/' . $forgot['id'] ); ?>
							...
							<?php endif; ?>
								...
								<div class="form-group">
									...
									<?php echo form_error('pass', '<small><span style="color:red;font-size: small">', '</strong></small><br>'); ?>
								</div>

                <div class="form-group">
									<label style="color:gray">Re-Type New Password</label>
									<input type="password" class="form-control" name="repass" placeholder="">
									<?php echo form_error('repass', '<small><span style="color:red;font-size: small">', '</strong></small><br>'); ?>
								</div>
