  ...
  <body style="background-image: url('<?php echo base_url(); ?>assets/new/plugins/images/new-users/1.jpg');background-position:center;background-repeat: no-repeat;background-size: cover;color:#006CB7">
		...
		<div class="row" style="margin:10px">
          ...
          <div class="row pull-right">
            <div class="col-md-5">
  					<a href="<?php echo base_url() . "login"; ?>" class="btn btn-primary btn-lg pull-right" style="margin-bottom:25px;width:100px">Sign In</a>
            </div>
            <div class="col-md-5">
  					<a href="<?php echo base_url() . "signup"; ?>" class="btn btn-primary btn-lg pull-right" style="margin-bottom:25px;width:100px">Sign Up</a>
            </div>
          </div>
		...
		<div class="row" style="margin:30px">
			...
			<div class="col-md-12">
					...
					<br>
					<br><br><br><br><br>
				<h2><b>Welcome to STI Sta. Maria<br>Queuing Management System</b></h2>
				<h3>Are you are a walk-in visitor?<br>Please click the button to check-in</h3> <br>
        <div class="">
