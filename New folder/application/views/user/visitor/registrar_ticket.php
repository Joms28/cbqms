    ...
    <div class="row">
      ...
      <div class="col-md-2">
        <ul class="nav nav-pills nav-stacked">
          ...
          <li role="presentation" class="active"><a href="<?php echo base_url() . "visitor-registrar"; ?>">REGISTRAR</a></li>
          <li role="presentation"><a href="<?php echo base_url() . "visitor-cashier"; ?>">CASHIER</a></li>
      ...
      <div class="col-md-10">
        <div class="panel  panel-primary">
          <div class="panel-heading">
            ACADEMIC DOCUMENT REQUEST AND SCHEDULE
          </div>
