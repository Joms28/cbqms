        ...
        <div class="panel  panel-primary">
          ...
          <div class="panel-body" style="padding:10px">
            ...
            <ul class="nav nav-tabs" style="margin-bottom:5px">
              <li role="presentation" class="active"><a href="<?php echo base_url() . "cms/user"; ?>">TEACHER</a></li>
              <li role="presentation"><a href="<?php echo base_url() . "cms/user/student"; ?>">STUDENT</a></li>
                  ...
                  <table  id="example" class="table table-bordered" >
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php echo ($user['status'] == 0 ? "<a href='' class='btn btn-xs btn-warning'>UNASSIGNED</a>" : "<a href='' class='btn btn-xs btn-success'>ASSIGNED</a>"); ?>
                          </td>
                          <td><?php echo $user['created_at']; ?></td>
                          <td>
                            <a href="" class="btn btn-xs btn-primary">VIEW SUBJECT LOAD</a>
                          </td>
                        </tr>
                        <?php
                        }
