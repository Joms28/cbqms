    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">CASHIER</h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            <ol class="breadcrumb ms-auto">
                                <li><a href="#" class="fw-normal">Cashier Appointment</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <!-- Column -->
                    <?php if($this->session->flashdata('respond-cashier')): ?>
                      <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="alert alert-success" role="alert">
                          <?php echo $this->session->flashdata('respond-cashier'); ?>
                        </div>
                      </div>
          					<?php endif; ?>
                    <!-- Column -->
                    <?php
                    if(!$this->main->check_user_sched_cashier($this->session->userdata('user_id'))) {
                    ?>
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="box-title" style="margin-bottom:20px;font-weight:bold">PAYMENT TRANSACTION</h4>
                                <?php echo form_open(base_url() . 'visitor-cashier', 'class="form-horizontal form-material"'); ?>
                                <div class="form-group mb-4">
                                    ...
                                    <div class="col-sm-12 border-bottom">
                                        <select class="form-select shadow-none p-0 border-0 form-control-line" id="selecttransaction" name="transaction">
                                          ...
                                          <option name="Uniform">Sales</option>
                                          <option name="Academic Document">Academic Document</option>
                                          <option name="Enrollment/Payment">Enrollment/Payment</option>
